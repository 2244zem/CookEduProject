...
-- Usernames are display names in CookEdu, not login identifiers. Keeping this
-- unique can make Supabase Auth return "Database error saving new user" when
-- two users pick the same name or email local-part.
do $$
declare
